...
public sealed class BagCleanupNpcInteractor
{
    ...
    private static readonly TimeSpan SelectSettleDelay = TimeSpan.FromMilliseconds(250);
        ...
        string npcName)
    {
        ...
        for (var attempt = 1; attempt <= maxAttempts; attempt++)
        {
            ...
            await DelayAsync(SelectSettleDelay, context.StopToken).ConfigureAwait(false);
