...
function M.mark_dialogue_jump_consumed(ctx, current_time, target, source, interaction_origin)
    ...
    logger(ctx).info(string.format(
        "[Leveling] dialogue jump consumed | task=%s origin=%s source=%s addr=%s at=%d",
