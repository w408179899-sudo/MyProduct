...
--============================================================================
-- 自定义主题: 暮烬 (Dusk Ember)
-- 深岩板蓝紫底色 + 琥珀铜强调色, 独立原创配色
--============================================================================

local function apply_theme()
    -- 基调色板
    local deep    = { r = 0.082, g = 0.078, b = 0.102, a = 1.0 }  -- 深岩板紫
    local main    = { r = 0.106, g = 0.098, b = 0.133, a = 1.0 }  -- 主背景
    local raised  = { r = 0.137, g = 0.125, b = 0.173, a = 1.0 }  -- 抬起面
    local sunken  = { r = 0.063, g = 0.059, b = 0.082, a = 1.0 }  -- 凹陷面
    local brd     = { r = 0.200, g = 0.180, b = 0.240, a = 0.45 } -- 边框

    local txt     = { r = 0.878, g = 0.855, b = 0.824, a = 1.0 }  -- 暖白文字
    local txt_d   = { r = 0.475, g = 0.440, b = 0.420, a = 1.0 }  -- 暗淡文字

    -- 强调色: 琥珀铜
    local ac      = { r = 0.824, g = 0.522, b = 0.184, a = 1.0 }  -- 琥珀
    local ac_hi   = { r = 0.906, g = 0.612, b = 0.255, a = 1.0 }  -- 亮琥珀
    local ac_lo   = { r = 0.580, g = 0.365, b = 0.133, a = 1.0 }  -- 暗琥珀

    local wg      = { r = 0.255, g = 0.235, b = 0.220, a = 1.0 }  -- 暖灰
    local cs      = { r = 0.180, g = 0.170, b = 0.210, a = 1.0 }  -- 冷石板

    local C = imgui
    imgui.set_style_colors({
        [C.Col_Text]                       = txt,
        [C.Col_TextDisabled]               = txt_d,
        [C.Col_WindowBg]                   = main,
        [C.Col_ChildBg]                    = { r = 0, g = 0, b = 0, a = 0 },
        [C.Col_PopupBg]                    = { r = 0.094, g = 0.086, b = 0.118, a = 0.96 },
        [C.Col_Border]                     = brd,
        [C.Col_BorderShadow]               = { r = 0, g = 0, b = 0, a = 0 },
        [C.Col_FrameBg]                    = sunken,
        [C.Col_FrameBgHovered]             = { r = 0.137, g = 0.125, b = 0.165, a = 1.0 },
        [C.Col_FrameBgActive]              = { r = 0.165, g = 0.149, b = 0.200, a = 1.0 },
        [C.Col_TitleBg]                    = deep,
        [C.Col_TitleBgActive]              = { r = 0.145, g = 0.133, b = 0.180, a = 1.0 },
        [C.Col_TitleBgCollapsed]           = { r = 0.063, g = 0.059, b = 0.082, a = 0.6 },
        [C.Col_MenuBarBg]                  = deep,
        [C.Col_ScrollbarBg]                = sunken,
        [C.Col_ScrollbarGrab]              = cs,
        [C.Col_ScrollbarGrabHovered]       = wg,
        [C.Col_ScrollbarGrabActive]        = ac_lo,
        [C.Col_CheckMark]                  = ac,
        [C.Col_SliderGrab]                 = ac_lo,
        [C.Col_SliderGrabActive]           = ac,
        [C.Col_Button]                     = raised,
        [C.Col_ButtonHovered]              = { r = 0.200, g = 0.180, b = 0.240, a = 1.0 },
        [C.Col_ButtonActive]               = ac_lo,
        [C.Col_Header]                     = raised,
        [C.Col_HeaderHovered]              = { r = 0.824, g = 0.522, b = 0.184, a = 0.22 },
        [C.Col_HeaderActive]               = ac_lo,
        [C.Col_Separator]                  = brd,
        [C.Col_SeparatorHovered]           = ac_lo,
        [C.Col_SeparatorActive]            = ac,
        [C.Col_ResizeGrip]                 = { r = 0.200, g = 0.180, b = 0.240, a = 0.25 },
        [C.Col_ResizeGripHovered]          = ac_lo,
        [C.Col_ResizeGripActive]           = ac,
        [C.Col_Tab]                        = deep,
        [C.Col_TabHovered]                 = { r = 0.200, g = 0.180, b = 0.240, a = 0.70 },
        [C.Col_TabSelected]                = { r = 0.165, g = 0.149, b = 0.200, a = 1.0 },
        [C.Col_TabSelectedOverline]        = ac,
        [C.Col_TabDimmed]                  = deep,
        [C.Col_TabDimmedSelected]          = main,
        [C.Col_TabDimmedSelectedOverline]  = { r = 0.400, g = 0.370, b = 0.350, a = 1.0 },
        [C.Col_DockingPreview]             = { r = 0.824, g = 0.522, b = 0.184, a = 0.55 },
        [C.Col_DockingEmptyBg]             = deep,
        [C.Col_PlotLines]                  = ac,
        [C.Col_PlotLinesHovered]           = ac_hi,
        [C.Col_PlotHistogram]              = ac,
        [C.Col_PlotHistogramHovered]       = ac_hi,
        [C.Col_TableHeaderBg]              = raised,
        [C.Col_TableBorderStrong]          = brd,
        [C.Col_TableBorderLight]           = { r = 0.180, g = 0.165, b = 0.220, a = 0.35 },
        [C.Col_TableRowBg]                 = { r = 0, g = 0, b = 0, a = 0 },
        [C.Col_TableRowBgAlt]              = { r = 1, g = 1, b = 1, a = 0.018 },
        [C.Col_TextLink]                   = ac_hi,
        [C.Col_TextSelectedBg]             = { r = 0.824, g = 0.522, b = 0.184, a = 0.28 },
        [C.Col_DragDropTarget]             = ac_hi,
        [C.Col_NavCursor]                  = ac,
        [C.Col_NavWindowingHighlight]      = { r = 1, g = 1, b = 1, a = 0.60 },
        [C.Col_NavWindowingDimBg]          = { r = 0.12, g = 0.10, b = 0.16, a = 0.58 },
        [C.Col_ModalWindowDimBg]           = { r = 0.06, g = 0.05, b = 0.08, a = 0.65 },
    })
    ...
    imgui.set_style({
        ...
        window_padding          = { x = 14.0, y = 12.0 },
        frame_padding           = { x = 10.0, y = 6.0 },
        item_spacing            = { x = 10.0, y = 7.0 },
        item_inner_spacing      = { x = 8.0,  y = 5.0 },
        cell_padding            = { x = 6.0,  y = 4.0 },
        button_text_align       = { x = 0.5, y = 0.5 },
        selectable_text_align   = { x = 0.0, y = 0.0 },
        window_title_align      = { x = 0.5, y = 0.5 },
        window_menu_button_position = imgui.Dir_Right,
    })
end
